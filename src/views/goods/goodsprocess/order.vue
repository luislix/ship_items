    ...
    <div class="ship">
      ...
      <van-panel class="ty-panel">
        <van-row gutter="20" class="ordertitle">
          ...
          <van-col span="8">运货待确认船只</van-col>
        </van-row>
        <van-row class="xq">
          <van-col span="5" offset="2"><p>托运船只 ：</p></van-col>
          <van-col span="4">{{ shipName }}</van-col>
          <p>详细情况<van-icon name="arrow" /></p>
        </van-row>
      </van-panel>
      <van-panel class="ms-pancel">
        <van-row gutter="20" class="ordertitle">
          ...
          <van-col span="7"><p>我发布的信息</p></van-col>
          <van-col span="1" offset="12"
            ><van-icon name="arrow-down" />
          </van-col>
        </van-row>
        <div class="ms">
          <van-row gutter="20" v-for="item in list" :key="item.id">
            <van-col span="5" offset="1">{{ item.label }}</van-col>
            <van-col span="3">{{ item.desc }}</van-col>
          </van-row>
          <van-row gutter="20">
            <van-col span="5" offset="1">详细地址:</van-col>
            <van-col span="10"
              ><p>湖北省武汉市<br />洪山区光谷大道解放路</p></van-col
            >
      ...
      <van-panel class="btn-panel">
        <van-button type="default">取消交易</van-button>
        <router-link to="/unloadGoods"
          ><van-button @click="clickbtnload" type="info"
            >同意装货</van-button
          ></router-link
        >
      </van-panel>
